...
export const homepageContent: HomepageContent = {
  ...
  coreNarrative: {
    ...
    stages: [
      ...
      { id: "customer-service", label: "Customer Service", description: "Resolve issues and build loyalty." },
      { id: "analytics", label: "Analytics", description: "Turn transactions into executive insight." },
    ],
